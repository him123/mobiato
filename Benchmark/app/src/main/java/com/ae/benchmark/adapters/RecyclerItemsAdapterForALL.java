 ...
 * */
public class RecyclerItemsAdapterForALL extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerItemsAdapterForALL(List<Item> itemList, Context context, boolean isViewOny) {
