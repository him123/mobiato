...
public class VerifyLoadActivity extends AppCompatActivity {
...
//    RecyclerView recyclerview_recent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_im_load);
        ButterKnife.inject(this);


        LayoutInflater mInflater = LayoutInflater.from(VerifyLoadActivity.this);
//
        ...
        mLayoutManager = new LinearLayoutManager(VerifyLoadActivity.this);
        recyclerview_load.setLayoutManager(mLayoutManager);

        recyclerAdapter = new RecyclerAdapterLoad(itemList, VerifyLoadActivity.this);
