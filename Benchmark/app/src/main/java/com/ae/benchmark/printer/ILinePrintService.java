        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case TRANSACTION_addLinePrintListener /*2*/:
                    data.enforceInterface(DESCRIPTOR);
                    addLinePrintListener(com.ae.benchmark.printer.ILinePrintListener.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case TRANSACTION_removeLinePrintListener /*3*/:
                    data.enforceInterface(DESCRIPTOR);
                    removeLinePrintListener(com.ae.benchmark.printer.ILinePrintListener.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 1598968902:
